    ...
    <Container>
      ...
      <div className={styles.content}>
        ...
        <aside>
          ...
          <div className={styles.text}>
            <p className={styles.textItem}>
              Код проекта находится тут - <a href="https://github.com/ArtemBalanoff/foodgram" className={styles.textLink}>Репозиторий</a>
            </p>
            <p className={styles.textItem}>
              Автор проекта: <a href="https://github.com/ArtemBalanoff" className={styles.textLink}>Артем Баланов</a>
            </p>
          </div>
        </aside>
      </div>
